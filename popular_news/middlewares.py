...
class PopularNewsSpiderMiddleware:
...
class PopularNewsDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
pwd = os.getcwd()
DRIVER_PATH = os.path.join(pwd, "driver/chromedriver.exe")


class SeleniumMiddlewareMiddleware(object):
    """下载器中间件"""
